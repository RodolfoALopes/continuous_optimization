...
int main() {
    ...
    const string name_method = "powell_bbo";
    const int id_version_const = 1;
    const scalar tol_line_search = 1e-20;

    string general_results = "general_powell_bbo_results.txt";
    string general_results_func = "general_powell_bbo_results_func.txt";
    scalar mean = 0.0;
    size_t cont_exp = 0;
