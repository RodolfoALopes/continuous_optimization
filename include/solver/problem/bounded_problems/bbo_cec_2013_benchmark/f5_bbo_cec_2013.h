#ifndef CONTINUOUS_OPTIMIZATION_F5_BBO_CEC_2013_H
#define CONTINUOUS_OPTIMIZATION_F5_BBO_CEC_2013_H
...
template<typename T>
class f5_bbo_cec_2013 : public bounded_problem_interface<T> {
public:
...
public:
    explicit f5_bbo_cec_2013(int dim) : Superclass(dim) {
