#ifndef CONTINUOUS_OPTIMIZATION_F2_BBO_CEC_2013_H
#define CONTINUOUS_OPTIMIZATION_F2_BBO_CEC_2013_H
...
template<typename T>
class f2_bbo_cec_2013 : public bounded_problem_interface<T> {
public:
...
public:
    explicit f2_bbo_cec_2013(int dim) : Superclass(dim) {
