#ifndef CONTINUOUS_NON_LINEAR_OPTIMIZATION_F9_GRAYBOX_CEC_H
#define CONTINUOUS_NON_LINEAR_OPTIMIZATION_F9_GRAYBOX_CEC_H
...
template<typename T>
class f9_graybox_cec : public bounded_problem_interface<T> {
public:
...
public:
    explicit f9_graybox_cec(int dim) : Superclass(dim) {
        o = vector_t(dim);
...
#endif //CONTINUOUS_NON_LINEAR_OPTIMIZATION_F9_GRAYBOX_CEC_H
