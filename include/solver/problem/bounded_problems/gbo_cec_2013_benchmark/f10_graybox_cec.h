#ifndef CONTINUOUS_NON_LINEAR_OPTIMIZATION_F10_GRAYBOX_CEC_H
#define CONTINUOUS_NON_LINEAR_OPTIMIZATION_F10_GRAYBOX_CEC_H
...
template<typename T>
class f10_graybox_cec : public bounded_problem_interface<T> {
public:
...
public:
    explicit f10_graybox_cec(int dim) : Superclass(dim) {
        o = vector_t(dim);
...
#endif //CONTINUOUS_NON_LINEAR_OPTIMIZATION_F10_GRAYBOX_CEC_H
